...
_ALLOWLIST = {
    "app.py": (27, "glue runtime/GUI Tk: teardown, callback after(), log e auto-start best-effort; "
                   "event journal best-effort (#230)"),
    ...
    "betfair/auth_client.py": (2, "errore login safe (niente response/segreti nel messaggio) + "
                                  "logout server-side best-effort (#168): un fallimento di rete non "
                                  "deve impedire la pulizia del token in RAM"),
